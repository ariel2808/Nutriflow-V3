...
import { X, Send, Mic, Edit3, Coffee, Sunrise, Sun, Moon, Apple, Salad, ChefHat } from 'lucide-react';
          ...
          <div className="px-6 pb-8">
            ...
            >
              <motion.button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-2xl transition-colors"
                style={{
                  borderWidth: '1px',
                  borderStyle: 'solid',
